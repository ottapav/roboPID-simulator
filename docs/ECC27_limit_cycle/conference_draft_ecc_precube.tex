...
moves. Each halving hands the state from one cube to a concentric cube of half
the side, so the error falls geometrically at a bounded number of iterations
...
\setlength{\itemsep}{-2.5pt}\setlength{\parsep}{0pt}
\itemsep0pt
